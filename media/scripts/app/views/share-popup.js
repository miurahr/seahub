define([
    ...
    var SharePopupView = Backbone.View.extend({
        ...
        events: {
            ...
            'submit #get-download-link-form': 'getDownloadLink',
            'submit #get-upload-link-form': 'getUploadLink',
        ...
        privateShareSubmit: function() {
            ...
            if (this.is_dir) {
                ...
                post_url = Common.getUrl({name: 'private-share-dir'});
            } else {
                var post_emails = "",
                    emails = $('[name="emails"]', form).val();
                if (!emails) {
                ...
                post_data['emails'] = post_emails;
                post_url = Common.getUrl({name: 'private-share-file'});
            };
...
//                    escapeMarkup: function(m) { return m; }
        ...
        getDownloadLink: function(e) {
            ...
            var _this = this, after_get_d_link;

            if (typeof e != 'undefined' && $(e.currentTarget).attr('id') == 'get-download-link-form') {
                var form = this.$get_d_link,
                    form_id = form.attr('id'),
                ...
                var after_get_d_link = function(data) {
                    form.hide();
                ...
                Common.ajaxPost({
                    ...
                    'after_op_success': after_get_d_link,
                    'form_id': form_id
                });
                return false;
            } else {
                after_get_d_link = function(data) {
        ...
        getUploadLink: function(e) {
            ...
            var _this = this, after_get_u_link;

            if (typeof e != 'undefined' && $(e.currentTarget).attr('id') == 'get-upload-link-form') {
                var form = this.$get_u_link,
                    form_id = form.attr('id'),
                ...
                after_get_u_link = function(data) {
                    if (data['upload_link']) {
                        form.hide();
                ...
                Common.ajaxPost({
                    ...
                    'after_op_success': after_get_u_link,
                    'form_id': form_id
                });
                return false;
            } else {
